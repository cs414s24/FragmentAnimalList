...
class AnimalListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        animalList.setOnItemClickListener { list, item, position, id ->
            ...
            viewModel = ViewModelProvider(requireActivity())[PositionViewModel::class.java]

            // 1. Alternative -- directly assign a value to the position variable in the ViewModel
            //viewModel.position = position

            // 2. Alternative -- use mutableLiveData
